  ...
  <main class="main-content position-relative border-radius-lg vh-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid p-0">
        <h6 class="font-weight-bolder text-white mb-0">Tambahkan Data Point Of Interest</h6>
            ...
            <div class="card-body">
              <form id="poi-form" class="mb-0">
                <div class="form-group">
                  ...
                  <input type="text" id="name" class="form-control" name="name" placeholder="Tugu Kemerdekaan" required>
                </div>
                <div class="form-group">
                ...
                <input type="double" id="lat" name="lat" placeholder="Latitude" class="d-none">
                <input type="double" id="lng" name="lng" placeholder="Longitude" class="d-none">
                <button type="submit" class="btn btn-primary mb-0">Tambah Data</button>
              </form>
            </div>
          </div>
        </div>
